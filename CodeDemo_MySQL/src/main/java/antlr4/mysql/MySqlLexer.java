...
public class MySqlLexer extends Lexer {
	...
	public static final int
		...
		RANDOM_BYTES=991, RELEASE_LOCK=992, REVERSE=993, ROUND=994, ROW_COUNT=995, 
		RPAD=996, RTRIM=997, SEC_TO_TIME=998, SECONDARY_ENGINE_ATTRIBUTE=999, 
		SESSION_USER=1000, SHA=1001, SHA1=1002, SHA2=1003, SCHEMA_NAME=1004, SIGN=1005, 
		...
		ST_AREA=1015, ST_ASBINARY=1016, ST_ASTEXT=1017, ST_ASWKB=1018, ST_ASWKT=1019, 
		ST_BUFFER=1020, ST_CENTROID=1021, ST_CONTAINS=1022, ST_CROSSES=1023, ST_DIFFERENCE=1024, 
		ST_DIMENSION=1025, ST_DISJOINT=1026, ST_DISTANCE=1027, ST_ENDPOINT=1028, 
		ST_ENVELOPE=1029, ST_EQUALS=1030, ST_EXTERIORRING=1031, ST_GEOMCOLLFROMTEXT=1032, 
		ST_GEOMCOLLFROMTXT=1033, ST_GEOMCOLLFROMWKB=1034, ST_GEOMETRYCOLLECTIONFROMTEXT=1035, 
		ST_GEOMETRYCOLLECTIONFROMWKB=1036, ST_GEOMETRYFROMTEXT=1037, ST_GEOMETRYFROMWKB=1038, 
		ST_GEOMETRYN=1039, ST_GEOMETRYTYPE=1040, ST_GEOMFROMTEXT=1041, ST_GEOMFROMWKB=1042, 
		ST_INTERIORRINGN=1043, ST_INTERSECTION=1044, ST_INTERSECTS=1045, ST_ISCLOSED=1046, 
		ST_ISEMPTY=1047, ST_ISSIMPLE=1048, ST_LINEFROMTEXT=1049, ST_LINEFROMWKB=1050, 
		ST_LINESTRINGFROMTEXT=1051, ST_LINESTRINGFROMWKB=1052, ST_NUMGEOMETRIES=1053, 
		ST_NUMINTERIORRING=1054, ST_NUMINTERIORRINGS=1055, ST_NUMPOINTS=1056, 
		ST_OVERLAPS=1057, ST_POINTFROMTEXT=1058, ST_POINTFROMWKB=1059, ST_POINTN=1060, 
		ST_POLYFROMTEXT=1061, ST_POLYFROMWKB=1062, ST_POLYGONFROMTEXT=1063, ST_POLYGONFROMWKB=1064, 
		ST_SRID=1065, ST_STARTPOINT=1066, ST_SYMDIFFERENCE=1067, ST_TOUCHES=1068, 
		ST_UNION=1069, ST_WITHIN=1070, ST_X=1071, ST_Y=1072, SUBDATE=1073, SUBSTRING_INDEX=1074, 
		SUBTIME=1075, SYSTEM_USER=1076, TAN=1077, TIMEDIFF=1078, TIMESTAMPADD=1079, 
		TIMESTAMPDIFF=1080, TIME_FORMAT=1081, TIME_TO_SEC=1082, TOUCHES=1083, 
		TO_BASE64=1084, TO_DAYS=1085, TO_SECONDS=1086, TP_CONNECTION_ADMIN=1087, 
		UCASE=1088, UNCOMPRESS=1089, UNCOMPRESSED_LENGTH=1090, UNHEX=1091, UNIX_TIMESTAMP=1092, 
		UPDATEXML=1093, UPPER=1094, UUID=1095, UUID_SHORT=1096, VALIDATE_PASSWORD_STRENGTH=1097, 
		VERSION=1098, WAIT_UNTIL_SQL_THREAD_AFTER_GTIDS=1099, WEEKDAY=1100, WEEKOFYEAR=1101, 
		WEIGHT_STRING=1102, WITHIN=1103, YEARWEEK=1104, Y_FUNCTION=1105, X_FUNCTION=1106, 
		VAR_ASSIGN=1107, PLUS_ASSIGN=1108, MINUS_ASSIGN=1109, MULT_ASSIGN=1110, 
		DIV_ASSIGN=1111, MOD_ASSIGN=1112, AND_ASSIGN=1113, XOR_ASSIGN=1114, OR_ASSIGN=1115, 
		STAR=1116, DIVIDE=1117, MODULE=1118, PLUS=1119, MINUS=1120, DIV=1121, 
		MOD=1122, EQUAL_SYMBOL=1123, GREATER_SYMBOL=1124, LESS_SYMBOL=1125, EXCLAMATION_SYMBOL=1126, 
		BIT_NOT_OP=1127, BIT_OR_OP=1128, BIT_AND_OP=1129, BIT_XOR_OP=1130, DOT=1131, 
		LR_BRACKET=1132, RR_BRACKET=1133, COMMA=1134, SEMI=1135, AT_SIGN=1136, 
		ZERO_DECIMAL=1137, ONE_DECIMAL=1138, TWO_DECIMAL=1139, SINGLE_QUOTE_SYMB=1140, 
		DOUBLE_QUOTE_SYMB=1141, REVERSE_QUOTE_SYMB=1142, COLON_SYMB=1143, CHARSET_REVERSE_QOUTE_STRING=1144, 
		FILESIZE_LITERAL=1145, START_NATIONAL_STRING_LITERAL=1146, STRING_LITERAL=1147, 
		DECIMAL_LITERAL=1148, HEXADECIMAL_LITERAL=1149, REAL_LITERAL=1150, NULL_SPEC_LITERAL=1151, 
		BIT_STRING=1152, STRING_CHARSET_NAME=1153, DOT_ID=1154, ID=1155, REVERSE_QUOTE_ID=1156, 
		STRING_USER_NAME=1157, IP_ADDRESS=1158, LOCAL_ID=1159, GLOBAL_ID=1160, 
	...
	private static final String _serializedATNSegment1 =
		...
		"\u0000RRrr\u0002\u0000WWww\u0002\u0000YYyy\u0002\u0000SSss\u0002\u0000"+
		"NNnn\u0002\u0000ZZzz\u0002\u0000CCcc\u0002\u0000IIii\u0002\u0000BBbb\u0002"+
		"\u0000UUuu\u0002\u0000FFff\u0002\u0000OOoo\u0002\u0000HHhh\u0002\u0000"+
		"KKkk\u0002\u0000GGgg\u0002\u0000MMmm\u0002\u0000VVvv\u0002\u0000PPpp\u0002"+
