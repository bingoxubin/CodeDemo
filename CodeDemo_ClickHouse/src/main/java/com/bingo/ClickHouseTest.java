...
public class ClickHouseTest {
	public static void main(String[] args) {
		...
		try {
			...
			ClickHouseDataSource dataSource = new ClickHouseDataSource("jdbc:clickhouse://192.168.214.11:8123/default?user=default&password=111111"); //default表示数据表 ,port原来为8123
